...
export default function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (!email.includes('@')) return 'To\'g\'ri email kiriting'
    ...
    <div className="min-h-screen bg-[#F8F7FF] dark:bg-[#0F0F1A] flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Yangi hisob yarating</p>
        </div>

        {/* Form card */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-5">Ro'yxatdan o'tish</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input
                ...
                required
                autoComplete="new-password"
                className={`w-full bg-gray-50 dark:bg-gray-700 rounded-xl px-4 py-3 text-sm text-gray-800 dark:text-gray-200 outline-none border-2 transition-colors placeholder-gray-400 ${
