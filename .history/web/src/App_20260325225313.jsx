  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen w-full bg-background text-foreground flex flex-col items-center transition-colors duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]">
        <div className="px-3 py-2 max-w-[1280px] w-full border-b border-b-[#0001] flex items-center justify-between rounded-bl-[20px] rounded-br-[20px] bg-background/95 backdrop-blur-sm transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] dark">
