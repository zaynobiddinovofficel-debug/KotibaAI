...
function AppContent() {
  ...
  const [kotibaPrompt, setKotibaPrompt] = React.useState("")
...
React.useEffect(() => {
    fetch('../prompt.txt')
      ...
      .catch(() => {
        setKotibaPrompt("KOTIBA_PROMPT fallback: Use updated prompt.txt for tasks and expenses.")
      })
  }, [])
  ...
  // sendRecording placeholder - full implementation requires merging with existing logic
