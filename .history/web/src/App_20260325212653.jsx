...
export default function App() {
  ...
  return (
    ...
    <div className="px-3 py-2 max-w-[1280px] w-full border-b border-b-[#0001] flex justify-between rounded-bl-[30px] rounded-br-[30px]">
    ...
    <div className="px-3 max-w-[1280px] w-full flex justify-center mt-auto border-t rounded-tl-[40px] rounded-tr-[40px] border-[#eee] bg-background/90 px-4 py-4 backdrop-blur-sm">
