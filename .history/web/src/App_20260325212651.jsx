...
export default function App() {
  ...
  return (
    ...
    <div className="px-3 max-w-[1280px] w-full flex justify-center mt-auto border-t rounded-tl-[4] rounded-tr-[4] border-[#eee] bg-background/90 px-4 py-4 backdrop-blur-sm">
