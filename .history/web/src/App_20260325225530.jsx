          ...
          <Route
            ...
            element={
              <>
                ...
                <div className="mx-3 px-3 max-w-[1280px] w-full flex justify-center mt-auto border-t rounded-tl-[40px] rounded-tr-[40px] border-[#eee] bg-background/90 px-4 py-4 backdrop-blur-sm transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] bg-red-500">
