...
export default function App() {
  ...
  return (
    ...
    <div className="px-3 max-w-[1280px] w-full flex justify-center mt-auto flex w-full max-w-md flex-col items-center gap-4 border-t border-[#eee] bg-background/90 px-4 py-4 shadow-sm backdrop-blur-sm">
